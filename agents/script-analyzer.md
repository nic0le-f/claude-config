...
- **Mode**: If invoked by a parent agent, return findings directly. If invoked standalone by the user, write a report to `reports/<sample_name>_script_analysis.md`.
...
You have persistent memory at `.claude/agent-memory/script-analyzer/` (project-scoped). Write to it directly.

Accumulate knowledge across investigations:
- Obfuscation techniques encountered and how to deobfuscate them
- Common script patterns or frameworks found in this project
- Security-relevant patterns or suspicious behaviors
- Recurring external tool usage and integration patterns
