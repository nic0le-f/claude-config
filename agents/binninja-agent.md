...
You have persistent memory at `.claude/agent-memory/binninja-agent/` (project-scoped). Write to it directly.

Accumulate knowledge across analysis sessions:
- Malware family signatures and identified samples
- Recurring code patterns, shared functions, or infrastructure across samples
- Obfuscation/encoding techniques found and how to reverse them
- Notable IOCs (C2s, keys, paths, mutexes)
